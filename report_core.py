...
from config import (
    ...
    # Kept only so tests/golden_report_core.py can assert the extracted
    # module's late-bound thresholds match what report_core resolved to.
    INSTITUTIONAL_TIER_A_SCORE,  # noqa: F401 - see the comment above
    INSTITUTIONAL_TIER_B_SCORE,  # noqa: F401 - see the comment above
    INSTITUTIONAL_TIER_C_SCORE,  # noqa: F401 - see the comment above
...
from institution_scanner.report_selection import (
    _apply_research_policy,
    _clean_group_key,  # noqa: F401 - re-exported so the golden gate can resolve it
    _diversify_ranked_candidates,
    _ensure_diversity_columns,
    _etf_theme_key,
    _institutional_tier,
    _policy_column,  # noqa: F401 - re-exported so the golden gate can resolve it
    _policy_text,  # noqa: F401 - re-exported so the golden gate can resolve it
    _policy_truthy,  # noqa: F401 - re-exported so the golden gate can resolve it
    _vectorized_etf_research_policy,  # noqa: F401 - re-exported so the golden gate can resolve it
)
