...
an overlay can be removed from production composition after equivalence tests;
keeping the inventory explicit prevents compatibility debt becoming invisible.
"""
...
RUNTIME_INVENTORY_VERSION: Final = "2026-09-04-v113-runtime-overlay-inventory-v3"
...
def runtime_inventory() -> dict[str, object]:
    ...
    return {
        ...
        "scan_overlays": scan,
        "retired_from_production_path": list(RETIRED_FROM_PRODUCTION_PATH),
