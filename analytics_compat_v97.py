...
contracts, point-in-time held-out scoping/maturity, shadow challengers,
hierarchical evidence, deterministic diagnostics and postprocess performance
safeguards live under the canonical ``institution_scanner`` package.
"""
...
ANALYTICS_COMPAT_VERSION = (
    "2026-08-25-v108.7-pit-maturity-deterministic-performance-bootstrap-v1"
)
