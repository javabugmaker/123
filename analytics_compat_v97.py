...
evidence and postprocess performance safeguards live under the canonical
``institution_scanner`` package.
"""
...
ANALYTICS_COMPAT_VERSION = (
    "2026-08-25-v106.6-pit-count-wide-frame-performance-bootstrap-v1"
)
...
def install() -> None:
    """Install PIT, governance, reliability and postprocess performance layers."""
